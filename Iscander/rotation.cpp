...
void rotation::fromRGtoAngles() {
	...
	Angles[2] = atan2(2 * (RG.RGPar[0] * RG.RGPar[1] - RG.RGPar[3] * RG.RGPar[2]), (pow(RG.RGPar[0], 2) + pow(RG.RGPar[2], 2) - pow(RG.RGPar[3], 2) - pow(RG.RGPar[1], 2)));
	Angles[1] = atan2(2 * (RG.RGPar[0] * RG.RGPar[2] - RG.RGPar[1] * RG.RGPar[3]), (pow(RG.RGPar[0], 2) + pow(RG.RGPar[1], 2) - pow(RG.RGPar[3], 2) - pow(RG.RGPar[2], 2)));
}
